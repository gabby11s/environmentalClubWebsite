 ...
 */
class Eco_Landscaping_Font_Select_Control extends WP_Customize_Control {
    /**
     * Enqueue styles.
     *
     * @access public
    ...
    public function enqueue() {
        wp_enqueue_style( 'eco-landscaping-typo-control-css', get_parent_theme_file_uri( 'inc/customizer/custom-controls/typography/typo-css.css', array(), '1.0', 'all' ));
    }
    ...
    public function render_content() {
        ...
        <button type="button" class="reset-font-button button button-primary" data-default="<?php echo esc_attr( $this->setting->default ); ?>">
            <?php esc_html_e( 'Reset', 'eco-landscaping' ); ?>
        </button>
        <script>
