	...
	function nature_bliss_site_branding() {
	    ...
	    <?php if ( true === $search_in_header ) : ?>
	    	<div class="header-search-box">
		    	<a href="#" class="search-icon"><i class="fa fa-search"><span class="screen-reader-text"><?php esc_html_e( 'Search', 'nature-bliss' ); ?></span></i></a>
		    	<div class="search-box-wrap">
		    		<div class="container">
 						<a href="#" class="search-close"><i class="fa fa-times-circle" aria-hidden="true"><span class="screen-reader-text"><?php esc_html_e( 'Close Search', 'nature-bliss' ); ?></span></i></a>
		    			<?php get_search_form(); ?>
		    		</div> <!-- .container -->
		    	</div><!-- .search-box-wrap -->
		...
		<?php if ( ! empty( $donate_text ) && ! empty( $donate_url ) ) : ?>
			<a href="<?php echo esc_url( $donate_url ); ?>" class="custom-button doante-now"><i class="fa-regular fa-circle-down" aria-hidden="true"></i><?php echo esc_html( $donate_text ); ?></a>
		<?php endif; ?>
...
if ( ! function_exists( 'nature_bliss_footer_goto_top' ) ) :
	...
	function nature_bliss_footer_goto_top() {
		...
		echo '<a href="#page" class="scrollup" id="btn-scrollup"><i class="fa-regular fa-circle-up" aria-hidden="true"><span class="screen-reader-text">' . esc_html__( 'Scroll Up', 'nature-bliss' ) . '</span></i></a>';
