...
= 2.1.4 - Mar 18 2024 =
* Fix: Custom.js issue in child theme

= 2.1.3 - Mar 14 2024 =
* WP 6.4 compatibility

= 2.1.2 - Aug 16 2022 =
* Fix: Accessibility added screen reader text for buttons
* Update: Google Font hosted locally (https://make.wordpress.org/themes/2022/06/18/complying-with-gdpr-when-using-google-fonts/)

= 2.1.1 - Jun 14 2022 =
* Fix: H1 tag on the homepage

= 2.1 - Jun 14 2022 =
* Fix: Keyboard Navigation menu
* Remove: sidr and implemented custom js
* Update: CSS for navigation and header
...
Nature Bliss WordPress Theme, Copyright 2015-2025 wenthemes.com
